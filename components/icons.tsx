...
export const CarIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14 16H9m10 0h1a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-1m-4 8H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h1m4 8v-2m0-4V6a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v2m0 4v2m0-4h4m-4 4h4m2-8h2"></path>
    </svg>
);
...
export const InnovateIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 18h6" />
        <path d="M10 22h4" />
        <path d="M12 14v4" />
        <path d="M8.5 12.5C8.5 8.36 10.08 5 12 5s3.5 3.36 3.5 7.5c0 2.21-1.79 4-4 4h-2c-2.21 0-4-1.79-4-4Z" />
    </svg>
);
...
export const RegistrationIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const DrivingLicenseIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M8 5v14"/><path d="M13 9h4"/><path d="M13 15h4"/><path d="M13 12h2"/></svg>
);

export const MarksheetIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>
);

export const RationCardIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 9V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4"/><path d="M2 15h20"/><path d="M4 15v5a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-5"/><path d="M10 3v18"/></svg>
);
...
export const DigiLockerLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 120 30" fill="currentColor"><text x="0" y="20" fontFamily="Poppins, sans-serif" fontSize="20" fontWeight="600">DigiLocker</text></svg>
);
export const MeriPehchaanLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 140 30" fill="currentColor"><text x="0" y="20" fontFamily="Poppins, sans-serif" fontSize="20" fontWeight="600">MeriPehchaan</text></svg>
);
export const UmangLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 80 30" fill="currentColor"><text x="0" y="20" fontFamily="Poppins, sans-serif" fontSize="20" fontWeight="600">UMANG</text></svg>
);
export const MySchemeLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 110 30" fill="currentColor"><text x="0" y="20" fontFamily="Poppins, sans-serif" fontSize="20" fontWeight="600">MyScheme</text></svg>
);
export const CbseLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 70 30" fill="currentColor"><text x="0" y="20" fontFamily="Poppins, sans-serif" fontSize="20" fontWeight="600">CBSE</text></svg>
);
export const GstnLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 70 30" fill="currentColor"><text x="0" y="20" fontFamily="Poppins, sans-serif" fontSize="20" fontWeight="600">GSTN</text></svg>
);
export const McLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 60 30" fill="currentColor"><text x="0" y="20" fontFamily="Poppins, sans-serif" fontSize="20" fontWeight="600">MCA</text></svg>
);
export const DigitalIndiaLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 150 40" fill="currentColor">
    <text x="0" y="25" fontFamily="Poppins, sans-serif" fontSize="20" fontWeight="bold">
      <tspan fill="#F7941D">Digital</tspan>
      <tspan fill="#00AEEF" dx="5">India</tspan>
    </text>
  </svg>
);
...
export const ConsumeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 12v-2a4 4 0 0 0-4-4H4"/><path d="M8 10v6a4 4 0 0 0 4 4h2"/><path d="M12 12h2a4 4 0 0 1 4 4v2"/><path d="M16 14h-6a4 4 0 0 1-4-4V4"/><circle cx="12" cy="12" r="10"/></svg>
);
